...
empty_game_save = {"mission": "1", "playtime": 0, "total kills": 0,
                   "total damages": 0, "kills": {}, "damages": {},
                   "court": {"King": "King", "Queen": "Queen", "Regent": "Regent"},
                   "story choice": {}, "dialogue log": [],
                   "unlock": {"character": [], "followers": [], "cutscene": []},
                   "new": {"character": [], "followers": [], "cutscene": []},
                   "favourite": {1: {"character": [], "followers": []}, 2: {"character": [], "followers": []}}}
