...
class MenuRotate(UIMenu):
    def __init__(self, pos, image, rotate_speed, rotate_left=True, start_angle=0):
        self._layer = -2
        UIMenu.__init__(self, player_cursor_interact=False, has_containers=True)
        self.image = image
...
class MenuActor(UIMenu):
    def __init__(self, pos, images, animation_frame_play_time=0.1, start_frame=0, layer=11, flip_sprite=False):
        self._layer = layer
